...
import static com.yuneec.imagefilterlibrary.TextureRotationUtil.TEXTURE_NO_ROTATION;
...
public class GPUImageRenderer implements GLSurfaceView.Renderer , Camera.PreviewCallback {
    ...
    public void onDrawFrame(final GL10 gl) {
        ...
        Log.e("OnDraw", " mFilter.onDraw "+ t22);
    ...
    public void setUpSurfaceTexture(final Camera camera) {
        runOnDraw(new Runnable() {
            ...
            public void run() {
                ...
                long t22=System.currentTimeMillis()-t11;
                Log.e("OnDraw", "setUpSurfaceTexture "+ t22);
            }
        });
    }
    ...
    public void setImageBitmap(final Bitmap bitmap, final boolean recycle) {
        ...
        runOnDraw(new Runnable() {
            ...
            public void run() {
                ...
                if (bitmap.getWidth() % 2 == 1) {               //这个if导致有些图片显示不了，设置这个if的意义？
